...
<div class="body">
	<div class="header">
		<p  class="logo"> <img onclick={() => location.reload()}  src={Logo} height="60px" width="60" alt="" /> </p>
			...
			<div class="programas">
				<div class="carta">
					<h3>
						...
						Tenemos muchos generos ya que intentamos tener la mayoria de libros, para que el lector esté satisfecho a la hora de buscar un libro de interes.
					</h3>
